...
export class Context {
    ...
    constructor(errorHandler: ErrorHandler, eventDispatcher: EventDispatcher, gameState: GameState, _inputHandler: InputHandler) {
    ...
    defineActor(name: string, options?: ActorOptions): Actor {
        ...
        this._actors[name] = new Actor(this._gameState, options);
    ...
    defineRoom(name: string): Room {
        ...
        this._rooms[name] = new Room(this, this._gameState);
